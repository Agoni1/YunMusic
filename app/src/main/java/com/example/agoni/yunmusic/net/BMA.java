package com.example.agoni.yunmusic.net;
...
public class BMA {
     ...
     * 轮播音乐封面
     * @param num 数量
     * @return http://tingapi.ting.baidu.com/v1/restserver/ting?from=android&version=5.6.5.6&format=json&method=baidu.ting.diy.gedanInfo&listid=354720797
     */
